...
def to_usd(i):
    delta = "$ {0:.2f}".format(float(i))
    return delta

def get_response(ticker, apikey):
...
if __name__ == "__main__":
    ...
    output.to_csv(ticker + "_" + a + b  + c + ".csv")
    ...
    print("LATEST DAILY CLOSING PRICE: " + to_usd(dolval(recclose)))

    print("THE 100-DAY LOW IS : " + to_usd(dolval(reclow)))
    print("THE 100-DAY HIGH IS: " + to_usd(dolval(rechigh)))
